...
-- This creates all tables. Run it ONCE when your project has no tables.
-- =============================================================================
...
CREATE INDEX IF NOT EXISTS idx_quests_action_type ON quests(action_type);
